...
${OBJECTDIR}/_ext/577f3b86/Smart_Record_Arena.o: ../../source/applications/terminal/examples/arenaSmarts/Smart_Record_Arena.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/_ext/577f3b86
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/577f3b86/Smart_Record_Arena.o ../../source/applications/terminal/examples/arenaSmarts/Smart_Record_Arena.cpp
...
${OBJECTDIR}/_ext/577f3b86/Smart_Record_nomain.o: ${OBJECTDIR}/_ext/577f3b86/Smart_Record_Arena.o ../../source/applications/terminal/examples/arenaSmarts/Smart_Record_Arena.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/577f3b86/Smart_Record_nomain.o ../../source/applications/terminal/examples/arenaSmarts/Smart_Record_Arena.cpp;\
	else  \
